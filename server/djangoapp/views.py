...
def get_dealer_details(request, dealer_id):
    ...
    if request.method == "GET":
        ...
        dealership = get_dealer_by_id_from_cf(dealer_url, dealer_id)[0]
        context['reviews'] = reviews
        context['dealership'] = dealership
        # Render dealership template
        return render(request, 'djangoapp/dealer_details.html', context)

# Create a `add_review` view to submit a review
def add_review(request, dealer_id):
    dealer_url      = "https://eu-gb.functions.appdomain.cloud/api/v1/web/cd3b050b-d3fd-4e7e-87b1-c696eff9ebb6/dealership-package/get-dealership"
    postreview_url  = "https://eu-gb.functions.appdomain.cloud/api/v1/web/cd3b050b-d3fd-4e7e-87b1-c696eff9ebb6/dealership-package/post-review"
    ...
    if request.method == 'GET':
        ...
        if request.user.is_authenticated:
            ...
            response = post_request(postreview_url, json_payload, dealerId=dealer_id)
